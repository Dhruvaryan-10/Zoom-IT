...
import DeliveryTracking from "./Components/Home/DeliveryTracking";
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/home/delhi/menu/:templateId" element={<MenuPage />} />
<Route path="/home/kolkata/menu/:templateId" element={<MenuPage />} />
<Route path="/home/chennai/menu/:templateId" element={<MenuPage />} />
<Route path="/home/bangalore/menu/:templateId" element={<MenuPage />} />
