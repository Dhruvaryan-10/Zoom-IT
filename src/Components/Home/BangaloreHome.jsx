...
const rawCuisineImageMap = {
  ...
  Biryani: "https://res.cloudinary.com/djgt0gsdl/image/upload/v1757672837/Biryani_tlsogg.jpg",
  Pizza: "https://res.cloudinary.com/djgt0gsdl/image/upload/v1757673560/Pizza_wpkhfw.jpg",
  Burger: "https://res.cloudinary.com/djgt0gsdl/image/upload/v1757673093/Burger_euwwhk.jpg",
};
...
const getCuisineImage = (cuisineData) => {
  ...
  const cuisines = cuisineData.split(",").map((c) => c.trim().toLowerCase());

  const match = cuisines.find((c) => cuisineImageMap[c]);

  return match ? cuisineImageMap[match] : FALLBACK_IMAGE_URL;
};
...
const BangaloreHome = () => {
  ...
  useEffect(() => {
    fetch("https://zoom-it-m6d0.onrender.com/api/home/bangalore")
      .then((res) => res.json())
  ...
  if (!templateId) {
    console.error(`Restaurant ${restaurant.name || restaurant.restaurant_name} has no template_id.`);
    window.alert("Menu not available for this restaurant.");
    return;
  }

  navigate(`/home/bangalore/menu/${templateId}`, {
    state: {
      ...
      <div className="relative z-10">
        ...
        <div className="flex">
          ...
          <div className={`transition-all duration-300 px-6 pt-[90px] w-full ${isSidebarOpen ? "md:ml-72" : ""}`}>
            ...
            >
              Discover Restaurants in Bangalore
            </motion.h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
              ...
              {filteredRestaurants.map((restaurant) => {
                ...
                const imageUrl = getCuisineImage(restaurant.cuisines);
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-4 flex flex-col flex-grow space-y-2">
                      ...
                      <p className="text-sm text-white/70">
                        💰 ₹{restaurant.approx_cost} for two
                      </p>

                      <p className="text-xs text-white/60">
                        🍲 {restaurant.dish_liked || "Popular dishes"}
                      </p>
                      ...
                      <div className="flex gap-3 text-xs text-white/60">
                        ...
                        <span>
                          🛵 {restaurant.online_order === "Yes" ? "Online Order" : "No Online Order"}
                        </span>

                        <span>
                          📅 {restaurant.book_table === "Yes" ? "Table Booking" : "No Booking"}
                        </span>
