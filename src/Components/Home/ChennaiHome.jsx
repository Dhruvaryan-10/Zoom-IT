                ...
                filteredRestaurants.map((restaurant) => (
                  ...
                  >
                    ...
                    <div className="text-sm space-y-1">
                      ...
                      <p>🥘 Top Dishes: {restaurant.top_dishes}</p>
                      <p>💸 Price for 2: ₹{restaurant.price_for_2}</p>
                      <p>⭐ Dining Rating: {restaurant.dining_rating}</p>
                      <p>🚚 Delivery Rating: {restaurant.delivery_rating}</p>
