...
const KolkataHome = () => {
  ...
  useEffect(() => {
    fetch("https://zoom-it-m6d0.onrender.com/api/home/kolkata")
      .then((res) => res.json())
  ...
  navigate(`/home/kolkata/menu/${templateId}`, {
    state: {
  ...
  <div className="relative z-10">
      ...
      <div className="flex">
        ...
        >
          ...
          >
            Discover Restaurants in Kolkata
          </motion.h1>
  ...
  filteredRestaurants.map((restaurant) => {
    ...
    return (
      <motion.div
        ...
        className="relative rounded-2xl overflow-hidden bg-white/5 backdrop-blur-md border border-white/10 shadow-xl flex flex-col"
      >
        ...
        <div className="p-4 flex flex-col flex-grow space-y-2">
          ...
          <p className="text-sm text-white/70">
            🍽 {restaurant.category || restaurant.cuisine || "Various"}
          </p>
          ...
          <div className="flex justify-between text-sm text-white/70">
            ...
            <span>💸 ₹{restaurant.pricing_for_2} for two</span>
